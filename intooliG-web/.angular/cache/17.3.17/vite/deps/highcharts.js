...
var require_highcharts = __commonJS({
 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        let u = (t3, e3) => {
          if (!t3.div) {
            let s2 = o(t3.element, "class"), r2 = t3.css, n2 = a("div", s2 ? { className: s2 } : void 0, __spreadProps(__spreadValues({ position: "absolute", left: `${t3.translateX || 0}px`, top: `${t3.translateY || 0}px` }, t3.styles), { display: t3.display, opacity: t3.opacity, visibility: t3.visibility }), t3.parentGroup?.div || e3);
        ...
        class N {
          ...
          setTickInterval(t3) {
            let { categories: e3, chart: i3, dataMax: s2, dataMin: r2, dateTime: o2, isXAxis: n2, logarithmic: a2, options: h2, softThreshold: l2 } = this, d2 = A(this.threshold) ? this.threshold : void 0, c2 = this.minRange || 0, { ceiling: p2, floor: u2, linkedTo: g2, softMax: f2, softMin: m2 } = h2, b2 = A(g2) && i3[this.coll]?.[g2], v2 = h2.tickPixelInterval, C2 = h2.maxPadding, M2 = h2.minPadding, w2 = 0, T2, P2 = A(h2.tickInterval) && h2.tickInterval >= 0 ? h2.tickInterval : void 0, L2, O2, D2, I2;
          ...
          adjustTickAmount() {
            let t3 = this, { finalTickAmt: e3, max: i3, min: s2, options: r2, tickPositions: o2, tickAmount: n2, thresholdAlignment: a2 } = t3, h2 = o2?.length, l2 = E(t3.threshold, t3.softThreshold ? 0 : null), d2, c2, p2 = t3.tickInterval, u2, g2 = () => o2.push(x(o2[o2.length - 1] + p2)), f2 = () => o2.unshift(x(o2[0] - p2));
        ...
        class p {
          static compose(e3, s2) {
            return i2(e3, "afterInit", function() {
              this.labelCollectors.push(() => {
                let t3 = [];
                for (let e4 of this.axes) for (let { label: i3, options: s3 } of e4.plotLinesAndBands) i3 && !s3?.label?.allowOverlap && t3.push(i3);
                return t3;
              });
            }), t2.compose(p, s2);
          }
          ...
          render() {
            ...
            if (!t3.chart.styledMode && (M ? (T.stroke = r2 || "#999999", T["stroke-width"] = c(e3.width, 1), e3.dashStyle && (T.dashstyle = e3.dashStyle)) : k && (T.fill = r2 || "#e6e9ff", x && (T.stroke = e3.borderColor, T["stroke-width"] = x))), p2.zIndex = a2, A += "-" + a2, (C = t3.plotLinesAndBandsGroups[A]) || (t3.plotLinesAndBandsGroups[A] = C = u.g("plot-" + A).attr(p2).add()), v || (this.svgElem = v = u.path().attr(T).add(C)), o(m)) S = t3.getPlotLinePath({ value: s2?.log2lin(m) ?? m, lineWidth: v.strokeWidth(), acrossPanes: e3.acrossPanes });
            else {
              if (!(o(f) && o(g))) return;
          ...
          renderLabel(t3, e3, i3, n2) {
            ...
            c2.align(t3, false, { x: g, y: f, width: m, height: s(u) - f }), (!c2.alignValue || "left" === c2.alignValue || o(d2)) && c2.css({ width: (t3.style?.width || (i3 && d2 ? m : 90 === c2.rotation ? a2.height - (c2.alignAttr.y - a2.top) : (t3.clip ? a2.width : a2.chart.chartWidth) - (c2.alignAttr.x - a2.left))) + "px" }), c2.show(true);
          }
          getLabelText(t3) {
        ...
        class S {
          ...
          pinch(t3) {
            let e3 = this, { chart: i3, hasZoom: s2, lastTouches: r2 } = e3, o2 = [].map.call(t3.touches || [], (t4) => e3.normalize(t4)), n2 = o2.length, a2 = 1 === n2 && (e3.inClass(t3.target, "highcharts-tracker") && i3.runTrackerClick || e3.runChartClick), h2 = i3.tooltip, l2 = 1 === n2 && y(h2?.options.followTouchMove, true);
        ...
        return function(t3) {
          function e3(t4, e4, o) {
            let n = this.legendItem = this.legendItem || {}, { chart: a, options: h } = this, { baseline: l = 0, symbolWidth: d, symbolHeight: c } = t4, p = this.symbol || "circle", u = c / 2, g = a.renderer, f = n.group, m = l - Math.round((t4.fontMetrics?.b || c) * (o ? 0.4 : 0.3)), x = {}, y, b = h.marker, v = 0;
            if (a.styledMode || (x["stroke-width"] = Math.min(h.lineWidth || 0, 24), h.dashStyle ? x.dashstyle = h.dashStyle : "square" === h.linecap || (x["stroke-linecap"] = "round")), n.line = g.path().addClass("highcharts-graph").attr(x).add(f), o && (n.area = g.path().addClass("highcharts-area").add(f)), x["stroke-linecap"] && (v = Math.min(n.line.strokeWidth(), d) / 2), d) {
              ...
              n.line.attr({ d: t5 }), n.area?.attr({ d: [...t5, ["L", d - v, l], ["L", v, l]] });
            }
        ...
        class X {
          ...
          applyZones() {
            let { area: t3, chart: e3, graph: i3, zones: s2, points: r2, xAxis: o2, yAxis: n2, zoneAxis: a2 } = this, { inverted: h2, renderer: l2 } = e3, d2 = this[`${a2}Axis`], { isXAxis: c2, len: p2 = 0 } = d2 || {}, u2 = (i3?.strokeWidth() || 0) / 2 + 1, g2 = (t4, e4 = 0, i4 = 0) => {
              h2 && (i4 = p2 - i4);
            ...
            if (s2.length && (i3 || t3) && d2 && j(d2.min)) {
              ...
              s2.forEach((e5) => {
                ...
                f2 = s3.reverse(), m2 = r3, h2 && (u3(v2), t3 && u3(b2)), a3 ? (a3.animate({ d: v2 }), d3?.animate({ d: b2 })) : (a3 = e5.clip = l2.path(v2), t3 && (d3 = e5.simpleClip = l2.path(b2))), i3 && e5.graph?.clip(a3), t3 && e5.area?.clip(d3);
              });
          ...
          setState(t3, e3) {
            ...
            if (t3 = t3 || "", i3.state !== t3 && ([i3.group, i3.markerGroup, i3.dataLabelsGroup].forEach(function(e4) {
              ...
              if (t3 && (h2 = n2[t3].lineWidth || h2 + (n2[t3].lineWidthPlus || 0), l2 = N(n2[t3].opacity, l2)), r2 && !r2.dashstyle && j(h2)) for (let t4 of [r2, ...this.zones.map((t5) => t5.graph)]) t4?.animate({ "stroke-width": h2 }, a2);
        ...
        class O {
          ...
          colorizeItem(t3, e3) {
            ...
            if (s2?.[e3 ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
              ...
              r2?.css(M(e3 ? this.itemStyle : s3)), o2?.attr(p2({ stroke: d2 || t3.color })), n2 && n2.attr(p2(c2 && n2.isMarker ? t3.pointAttribs() : { fill: t3.color })), i3?.attr(p2({ fill: h2 || t3.color, "fill-opacity": h2 ? 1 : l2 ?? 0.75 }));
            }
        ...
        class Q {
          ...
          isInsidePlot(t3, e3, i3 = {}) {
            let { inverted: s2, plotBox: r2, plotLeft: o2, plotTop: n2, scrollablePlotBox: a2 } = this, { scrollLeft: h2 = 0, scrollTop: l2 = 0 } = i3.visiblePlotOnly && this.scrollablePlotArea?.scrollingContainer || {}, d2 = i3.series, c2 = i3.visiblePlotOnly && a2 || r2, p2 = i3.inverted ? e3 : t3, u2 = i3.inverted ? t3 : e3, g2 = { x: p2, y: u2, isInsidePlot: true, options: i3 };
            if (!i3.ignoreX) {
          ...
          pan(t3, e3) {
            ...
            n2?.panning && (n2.panning = s2), N(this, "pan", { originalEvent: t3 }, () => {
        ...
        class g {
          ...
          applyFixed() {
            ...
            e3.setSize(n2, a2), (i3 ?? true) && (this.isDirty = false, this.moveFixedElements()), r(t3.container), h(d2, { width: `${b}px`, height: `${v}px` }), t3.renderer.boxWrapper.attr({ width: b, height: v, viewBox: [0, 0, b, v].join(" ") }), t3.chartBackground?.attr({ width: b, height: v }), h(s2, { width: `${n2}px`, height: `${a2}px` }), l(i3) || (s2.scrollLeft = f * x, s2.scrollTop = m * y);
        ...
        class w {
          ...
          renderStackTotals() {
            let t3 = this.axis, e3 = t3.chart, i3 = e3.renderer, s2 = this.stacks, r2 = n(e3, t3.options.stackLabels?.animation || false), o2 = this.stackTotalGroup = this.stackTotalGroup || i3.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add();
          ...
          function r2() {
            ...
            t3.visible && t3.hasDataLabels?.() && (e4.forEach((t4) => {
              ...
              (t4.dataLabels || []).forEach((e5, i5) => {
                ...
                0 === i5 && m2[t4.half].push(t4), !p(r4?.style?.width) && e5.getBBox().width > n2 && (e5.css({ width: Math.round(0.7 * n2) + "px" }), e5.shortened = true), e5.dataLabelPosition = this.getDataLabelPosition(t4, o4), C = Math.max(C, o4);
              });
            }), m2.forEach((e5, n3) => {
              ...
              l2 && (t3.sortByAngle(e5, n3 - 0.5), C > 0 && (f2 = Math.max(0, g2 - c2 - C), m3 = Math.min(g2 + c2 + C, i4.plotHeight), e5.forEach((t4) => {
                (t4.dataLabels || []).forEach((e6) => {
                  ...
                  s4 && s4.distance > 0 && (s4.top = Math.max(0, g2 - c2 - s4.distance), s4.bottom = Math.min(g2 + c2 + s4.distance, i4.plotHeight), b2 = e6.getBBox().height || 21, e6.lineHeight = i4.renderer.fontMetrics(e6.text || e6).h + 2 * e6.padding, t4.distributeBox = { target: (e6.dataLabelPosition?.natural.y || 0) - s4.top + e6.lineHeight / 2, size: b2, rank: t4.y }, d2.push(t4.distributeBox));
                });
        ...
        function a(t3) {
          ...
          for (let i3 = 0; i3 < e3; i3++) (n2 = t3[i3]) && (n2.oldOpacity = n2.opacity, n2.newOpacity = 1, n2.absoluteBox = function(t4) {
            if (t4 && (!t4.alignAttr || t4.placed)) {
              ...
              return t4.width = s3.width, t4.height = s3.height, { x: i4.x + (t4.parentGroup?.translateX || 0) + e4, y: i4.y + (t4.parentGroup?.translateY || 0) + e4, width: (t4.width || 0) - 2 * e4, height: (t4.height || 0) - 2 * e4, polygon: s3?.polygon };
            }
          }(n2));
        ...
        function g() {
          if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
            let { options: t3, yAxis: e3 } = this, i3 = "percent" === t3.stacking, r2 = s.plotOptions?.[this.type]?.borderRadius, o2 = f(t3.borderRadius, a(r2) ? r2 : {}), h2 = e3.options.reversed;
